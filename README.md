...
| no. | approach (design)                               | eval. iters. | $d_\infty$           | mean time [s] | speed-up     | mean time [s] | speed-up     |
|:----|:------------------------------------------------|:------------:|:--------------------:|--------------:|-------------:|--------------:|-------------:|
...
| 1   | `jcr_pi_contraction_cpu_numpy`                  | 326          | 0.6 $\cdot$ 10<sup>-4</sup> | 1.894         | $\times$ 1.0 | 1.054         | $\times$ 1.8 |
| 2   | `jcr_pi_contraction_cpu_numba_parallel`         | 326          | 0.6 $\cdot$ 10<sup>-4</sup> | 0.028         | $\times$ 67.6| 0.009         | $\times$ 210.4|
| 3   | `jcr_pi_contraction_cuda_atomicmax`             | 325          | 0.6 $\cdot$ 10<sup>-4</sup> | 0.028         | $\times$ 67.6| 0.010         | $\times$ 189.4|
| 4   | `jcr_pi_contraction_cuda_atomicmaxplain`        | 325          | 0.6 $\cdot$ 10<sup>-4</sup> | 0.029         | $\times$ 65.3| 0.011         | $\times$ 172.2|
...
| 36  | `jcr_pi_contraction_cuda_gridsync`              | 406          | 0.6 $\cdot$ 10<sup>-4</sup> | 0.594         | $\times$ 147.2| 0.159        | $\times$ 549.8|
