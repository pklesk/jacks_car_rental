# Jack's Car Rental (JCR): CPU and GPU/CUDA implementations of policy iteration
...
four CUDA- and two CPU-based implementations of policy iteration for the JCR problem.
