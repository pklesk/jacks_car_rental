...
<table width="100%">
  <tr>
    <td width="30%">$V_0$, $\pi_0$</td>
    <td width="30%">$\xrightarrow{\textrm{E}}V_1\approx v_{\pi_0}\xrightarrow{\textrm{I}}\pi_1$</td>
    <td width="4%">$\cdots$</td>
    <td width="30%">$\xrightarrow{\textrm{E}}V_4\approx v_{\pi_3}\xrightarrow{\textrm{I}}\pi_4=\pi^*$</td>
  </tr>
  <tr>
